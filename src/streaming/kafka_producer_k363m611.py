"""src/streaming/kafka_producer_k363m611.py - Kafka producer example.
...
Terminal command to run this file from the root project folder:
    ...
    uv run python -m streaming.kafka_producer_k363m611
...
from streaming.data_validation.data_validation_k363m611 import (
